...
import { addSortie, upsertCheckForme } from '../db/events';
...
import { SortieModal, type DonneesSortie } from './SortieModal';
import { CheckFormeModal } from './CheckFormeModal';
import { ExportImport } from './ExportImport';
import { FormeTendance } from './FormeTendance';
...
export function EcranAccueil({
  ...
  const afficherCheckForme = !formeAujourdhui && !formePasseeCetteSession;
